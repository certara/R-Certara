...
#save_as_image(dm_table, path = "./tables/dmtable")
save_files(dm_table, name = "dmtable", type = "table")
...
#save_as_image(mean_conc_dosegrp_time_tbl, path = "./tables/mean_conctable")
save_files(mean_conc_dosegrp_time_tbl, name = "mean_conctable", type = "table")
...
#ggsave("./plots/time_concentration_by_subject", plot = p1)
save_files(p1, name = "time_concentration_by_subject", type = "plot")

# * 4.2 Time-Concentration by Subject Faceted by Dose Group ----
p2 <- p1 + facet_wrap( ~ DOSEGRP) + theme_certara()

#ggsave("./plots/time_concentration_by_subject_facet_dose_group", plot = p2)
save_files(p2, name = "time_concentration_by_subject_facet_dose_group", type = "plot")

# * 4.3 Time-Concentration by Gender & Dose Group ----
p3 <- p2 + aes(color=SEX) + theme_certara()

#ggsave("./plots/time_concentration_facet_dose_group", plot = p3)
save_files(p3, name = "time_concentration_facet_dose_group", type = "plot")

# * 4.4 Time-Concentration by Subject Faceted by Dose Group & Gender ----
p4 <- p1 + facet_wrap(DOSEGRP~SEX,ncol=2) + theme_certara()

#ggsave("./plots/time_concentration_by_subject_facet_dose_group_gender", plot = p4)
save_files(p4, name = "time_concentration_by_subject_facet_dose_group_gender", type = "plot")
...
#ggsave("./plots/time_concentration_by_subject_facet_dose_group_race", plot = p5)
save_files(p5, name = "time_concentration_by_subject_facet_dose_group_race", type = "plot")
...
#ggsave("./plots/time_concentration_by_subject_by_wt_cut", plot = p6)
save_files(p6, name = "time_concentration_by_subject_by_wt_cut", type = "plot")
...
#ggsave("./plots/time_concentration_by_subject_by_age_quantile", plot = p7)
save_files(p7, name = "time_concentration_by_subject_by_age_quantile", type = "plot")
